...
$articles = @(
  ...
  @{ slug='salesforce-ai-tools-comparison'; file='salesforce_ai_tools_comparison.html'; title='AI Tools for Salesforce Development - Claude, Codex, Agentforce, Gemini'; summary='A practical comparison of Claude, Codex, Agentforce, and Gemini across the Salesforce implementation lifecycle, with pros, cons, and fit-by-use-case guidance.'; image='https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=1400&q=80'; diagram='../assets/diagrams/agent-reasoning-flow.svg'; diagramAlt='AI tooling comparison for Salesforce teams'; readTime='14 min read'; category='AI Strategy'; date='2026-03-12'; focus='reasoning' }
)
...
<body><header class="site-header"><div class="header-inner"><a class="brand" href="../index.html"><span class="brand-mark">Salesforce Agentforce Blog</span><span class="brand-sub">Shivam Gupta  -  Salesforce Architect</span></a><nav class="nav-links" aria-label="Primary"><a href="../index.html">Home</a><a href="../index.html#articles">Articles</a><a href="../../codex-claude-salesforce-guide/index.html">AI Guide</a><a href="https://pulsagi.com" rel="noopener" target="_blank">Pulsagi</a></nav></div></header>
