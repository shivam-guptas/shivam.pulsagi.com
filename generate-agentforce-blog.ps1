...
<body><header class="site-header"><div class="header-inner"><a class="brand" href="./index.html"><span class="brand-mark">Salesforce Agentforce Blog</span><span class="brand-sub">Shivam Gupta  -  Salesforce Architect</span></a><nav class="nav-links" aria-label="Primary"><a href="#articles">Articles</a><a href="https://shivam.pulsagi.com/">Main site</a><a href="https://pulsagi.com" rel="noopener" target="_blank">Pulsagi</a></nav></div></header><main class="page-shell"><section class="hero"><div class="hero-card"><div class="hero-grid"><div class="hero-copy"><div class="eyebrow">SEO Blog Section  -  GitHub Pages Ready</div><h1>Salesforce Agentforce articles for architects, admins, and developers.</h1><p>This section contains ten long-form technical articles about Salesforce Agentforce, written in a documentation-first blog format. Each page includes structured SEO metadata, author information, responsive layout, tables of contents, code samples, and architecture diagrams.</p><p>The content is designed for readers who want implementation detail instead of generic AI commentary: how the platform is structured, how to configure it, how to secure it, and how to deploy it responsibly.</p><div class="hero-actions"><a class="button button-primary" href="#articles">Browse articles</a><a class="button button-secondary" href="./manifest.json">Open manifest</a></div></div><div class="hero-media"><div class="hero-metrics"><div class="metric"><strong>10</strong><span>Detailed technical articles</span></div><div class="metric"><strong>SEO</strong><span>OpenGraph and schema included</span></div><div class="metric"><strong>HTML</strong><span>Static pages for GitHub Pages</span></div><div class="metric"><strong>Responsive</strong><span>Readable on desktop and mobile</span></div></div><div class="hero-portrait"><img src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=1400&q=80" alt="Salesforce Agentforce analytics dashboard" /></div></div></div></div></section><section class="section"><h2 class="section-heading">What this section includes</h2><p class="section-intro">The blog collection covers foundational architecture, first-build implementation, prompt design, custom Apex actions, external APIs, service automation, security and trust, Data Cloud grounding, multi-step reasoning, and production deployment.</p><div class="card-grid"><article class="card"><h3>Technical depth</h3><p>Each article follows a consistent structure with introduction, architecture explanation, configuration steps, diagrams, code examples, best practices, and conclusion.</p></article><article class="card"><h3>SEO-ready output</h3><p>Every page includes meta description, OpenGraph tags, canonical URLs, and <code>BlogPosting</code> schema for straightforward static hosting.</p></article><article class="card"><h3>Author identity</h3><p>All content is attributed to Shivam Gupta with an author block aligned to the site identity of Salesforce Architect and founder of Pulsagi.</p></article></div></section><section class="section" id="articles"><h2 class="section-heading">Articles</h2><p class="section-intro">Open any article below to read the full guide. The layout is inspired by modern editorial platforms while remaining lightweight and static-host friendly.</p><div class="article-list">$indexCards</div></section></main><footer class="site-footer"><div class="footer-inner"><span>(c) 2026 Shivam Gupta  -  Salesforce Agentforce Blog</span><span><a href="https://shivam.pulsagi.com/">Back to main site</a></span></div></footer></body></html>
"@
